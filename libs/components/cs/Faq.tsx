	...
	const data: any = {
		vehicle: [
			{
				...
				subject: 'Are the Vehicles displayed on the site reliable?',
				content: 'of course we only have verified Vehicles',
			},
			{
				id: '00f5a45ed8897f8090116a22',
				subject: 'What types of Vehicles do you offer?',
				content: 'We offer single-family homes, condos, townhouses, apartments, and penthouses',
			},
			{
				id: '00f5a45ed8897f8090116a21',
				subject: 'How can I search for Vehicles on your website?',
				content: 'Simply use our search bar to enter location, price range, bedrooms/bathrooms, and vehicle type.',
			},
			{
			...
			},
			{
				...
				subject: 'What should I consider when buying a vehicle?',
			...
			},
			{
				...
				subject: 'What happens if I encounter issues with the vehicle after purchase?',
				content: 'We offer post-purchase support to address any concerns promptly.',
			},
			{
				id: '00f5a45ed8897f8090116a28',
				subject: 'Do you offer Vehicles in specific neighborhoods?',
				content: 'Yes, we have listings in various neighborhoods based on your preferences.',
			},
			{
				id: '00f5a45ed8897f8090116a27',
				subject: 'Can I sell my vehicle through your website?',
				content: 'Absolutely, we provide services for selling Vehicles as well.',
			},
			{
				id: '00f5a45ed8897f8090116b99',
				subject: 'What if I need help understanding legal aspects of vehicle purchase?',
		...
		payment: [
			...
			},
			{
				...
				content: 'Yes, we offer installment payment plans for certain Vehicles. Please inquire for more details.',
			},
			{
		...
		buyers: [
			{
				...
				content: 'Buyers should check and decide whether the vehicle they want to buy or rent is actually suitable!',
			},
			{
				id: '00f5a45ed8897f8090116a85',
				subject: 'How can I determine if a vehicle is within my budget?',
				content:
			...
			},
			{
				...
				subject: 'What documents do I need to provide when purchasing a vehicle?',
				content:
			...
			},
			{
				...
				content:
					'Yes, you can negotiate the price of a vehicle. Our dealers will assist you in making competitive offers and negotiating terms with the seller.',
			},
			{
				id: '00f5a45ed8897f8090116a81',
				subject: 'What are some red flags to watch out for when viewing Vehicles?',
				content:
			...
			},
			{
				...
				subject: 'Do you provide assistance with vehicle inspections?',
				content:
					'Yes, we can recommend reputable inspectors and accompany you during vehicle inspections to identify any potential issues.',
			},
			{
				id: '00f5a45ed8897f8090116a79',
				subject: 'How long does it typically take to find the right vehicle?',
				content:
					'The timeframe varies depending on your preferences and market conditions. Our dealers will work diligently to find the right vehicle as quickly as possible.',
			},
			{
				id: '00f5a45ed8897f8090116a78',
				subject: 'What are the advantages of using a real estate dealer when buying a vehicle?',
				content:
			...
			},
			{
				...
				subject: 'What happens if I change my mind about a vehicle after making an offer?',
				content:
		...
		dealers: [
			...
			},
			{
				...
				subject: 'What are some effective marketing strategies for selling Vehicles?',
		...
		membership: [
			...
			},
			{
				...
				subject: 'Do members receive discounts on vehicle listings or services?',
		...
		return (
			<Stack className={'faq-content'}>
				<Box className={'categories'} component={'div'}>
					<div
						className={category === 'vehicle' ? 'active' : ''}
						onClick={() => {
							changeCategoryHandler('vehicle');
						}}
					>
						vehicle
					</div>
